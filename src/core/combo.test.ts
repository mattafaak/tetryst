...
describe("combo", () => {
  it("first clear increments combo from 0 to 1", () => {
  ...
  it("subsequent clears increment combo", () => {
    ...
    expect(result.bonusScore).toBe(COMBO_BASE * 2 * 1);
  });
